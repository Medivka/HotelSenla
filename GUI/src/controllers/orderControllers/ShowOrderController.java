...
public class ShowOrderController implements IController {
    ...
    @FXML
    private Button showAllOrder;

    @FXML
    private ScrollPane findOrder;
    ...
    void initialize() {
        ...
        orderFind.setOnAction(actionEvent -> {
            ...
            findOrder.setContent(orderLabel);

        });
        showAllOrder.setOnAction(actionEvent -> {

            orderLabel.setText(fasadOrder.showAllOrder().toString());
            findOrder.setContent(orderLabel);
        });
