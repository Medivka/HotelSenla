...
import main.actions.guest.*;
import main.actions.history.GetAllHistory;
import main.actions.history.GetThreeLastGuestInRoom;
import main.actions.history.ShowAllRoomGuest;
import main.actions.order.*;
import main.actions.room.*;
import main.actions.room.FindById;
import main.actions.service.ChangeServiceName;
import main.actions.service.ChangeServicePrice;
import main.actions.service.CreateNewService;
import main.actions.service.ShowAllService;
...
public class Builder {
    ...
    private Menu createServiceMenu() {
        ...
        serviceMenu.addMenuItem(new MenuItem("Find by id", new main.actions.service.FindById(), rootMenu));
        serviceMenu.addMenuItem(new MenuItem("Show all com.service", new ShowAllService(), rootMenu));
        serviceMenu.addMenuItem(new MenuItem("Sorted by price", new main.actions.service.SortedByPrice(), rootMenu));
    ...
    private Menu createGuestMenu() {
        ...
        guestMenu.addMenuItem(new MenuItem("Change guest age", new actions.guest.ChangeGuestAge(), rootMenu));
        guestMenu.addMenuItem(new MenuItem("Find by id", new main.actions.guest.FindById(), rootMenu));
    ...
    private Menu createOrderMenu() {
        ...
        orderMenu.addMenuItem(new MenuItem("Find by ID", new main.actions.order.FindById(), rootMenu));
        return orderMenu;
    }
